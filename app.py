...
def form_input():
    ...
    with cols[0]:
        st.session_state["selected_language"] = st.selectbox(
            "🌐 Preferred Language",
            ["English", "Odia", "Hindi", "Bengali", "Telugu", "Tamil", "Malayalam", "Kannada","Gujarati","Marathi","Punjabi","Urdu","Assamese","Bodo","Dogri","Kashmiri","Konkani","Manipuri","Nepali","Sanskrit"],
        )

    with cols[2]:
        category = st.selectbox("📚 Your Interest", ["articles","Environment","business","Tech"])
...
def summarize_text(text, language):
    ...
    - Maximum 500 words of every lqnguage given above 
    Text: {text}"""
